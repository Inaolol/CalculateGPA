...
export const DEFAULT_DATA = [
  {
    id: uid(), label: "Year 1", academic: "2023 — 2024",
    semesters: [
      {
        id: uid(), kind: "fall", title: "Fall 2023",
        courses: [
          { id: uid(), code: "MATH151", name: "Calculus I",                      ects: 6, type: "C", grade: "BA" },
          { id: uid(), code: "PHYS101", name: "Physics I",                       ects: 5, type: "C", grade: "BB" },
          { id: uid(), code: "SE101",   name: "Introduction to Programming",     ects: 7, type: "C", grade: "AA" },
          { id: uid(), code: "SE103",   name: "Discrete Mathematics",            ects: 5, type: "C", grade: "BA" },
          { id: uid(), code: "ENG101",  name: "Academic English I",              ects: 3, type: "C", grade: "BB" },
          { id: uid(), code: "TUR101",  name: "Turkish Language I",              ects: 2, type: "C", grade: "AA" },
          { id: uid(), code: "HIST101", name: "Principles of Atatürk I",         ects: 2, type: "C", grade: "BA" },
        ],
      },
      {
        id: uid(), kind: "spring", title: "Spring 2024",
        courses: [
          { id: uid(), code: "MATH152", name: "Calculus II",                     ects: 6, type: "C", grade: "BB" },
          { id: uid(), code: "PHYS102", name: "Physics II",                      ects: 5, type: "C", grade: "CB" },
          { id: uid(), code: "SE102",   name: "Object-Oriented Programming",     ects: 7, type: "C", grade: "AA" },
          { id: uid(), code: "SE104",   name: "Data Structures",                 ects: 6, type: "C", grade: "BA" },
          { id: uid(), code: "ENG102",  name: "Academic English II",             ects: 3, type: "C", grade: "BA" },
          { id: uid(), code: "TUR102",  name: "Turkish Language II",             ects: 2, type: "C", grade: "AA" },
          { id: uid(), code: "HIST102", name: "Principles of Atatürk II",        ects: 2, type: "C", grade: "BB" },
        ],
      },
    ],
  },
  {
    id: uid(), label: "Year 2", academic: "2024 — 2025",
    semesters: [
      {
        id: uid(), kind: "fall", title: "Fall 2024",
        courses: [
          { id: uid(), code: "SE201",   name: "Algorithms",                      ects: 7, type: "C", grade: "AA" },
          { id: uid(), code: "SE203",   name: "Computer Organization",           ects: 6, type: "C", grade: "BB" },
          { id: uid(), code: "MATH211", name: "Linear Algebra",                  ects: 5, type: "C", grade: "BA" },
          { id: uid(), code: "MATH215", name: "Probability & Statistics",        ects: 5, type: "C", grade: "CB" },
          { id: uid(), code: "SE205",   name: "Database Systems",                ects: 5, type: "C", grade: "AA" },
          { id: uid(), code: "ELEC201", name: "Technical Elective: Web Design",  ects: 3, type: "E", grade: "BA" },
        ],
      },
      {
        id: uid(), kind: "spring", title: "Spring 2025",
        courses: [
          { id: uid(), code: "SE202",   name: "Operating Systems",               ects: 7, type: "C", grade: "BA" },
          { id: uid(), code: "SE204",   name: "Software Engineering",            ects: 6, type: "C", grade: "AA" },
          { id: uid(), code: "SE206",   name: "Computer Networks",               ects: 6, type: "C", grade: "BB" },
          { id: uid(), code: "MATH216", name: "Numerical Methods",               ects: 5, type: "C", grade: "CB" },
          { id: uid(), code: "ELEC202", name: "Mobile App Development",          ects: 3, type: "E", grade: "AA" },
          { id: uid(), code: "ELEC203", name: "Game Design",                     ects: 3, type: "E", grade: "BA" },
        ],
      },
    ],
  },
  {
    id: uid(), label: "Year 3", academic: "2025 — 2026",
    semesters: [
      {
        id: uid(), kind: "fall", title: "Fall 2025",
        courses: [
          { id: uid(), code: "SE301",   name: "Web Application Development",    ects: 6, type: "C", grade: "AA" },
          { id: uid(), code: "SE303",   name: "Artificial Intelligence",         ects: 6, type: "C", grade: "BA" },
          { id: uid(), code: "SE305",   name: "Human–Computer Interaction",      ects: 5, type: "C", grade: "AA" },
          { id: uid(), code: "SE307",   name: "Formal Languages & Automata",     ects: 5, type: "C", grade: "BB" },
          { id: uid(), code: "ELEC301", name: "Cloud Computing",                 ects: 4, type: "E", grade: "BA" },
          { id: uid(), code: "ELEC303", name: "Information Security",            ects: 4, type: "E", grade: "BA" },
        ],
      },
      {
        id: uid(), kind: "spring", title: "Spring 2026",
        courses: [
          { id: uid(), code: "SE302",   name: "Software Architecture",           ects: 6, type: "C", grade: "" },
          { id: uid(), code: "SE304",   name: "Machine Learning",                ects: 6, type: "C", grade: "" },
          { id: uid(), code: "SE306",   name: "Compiler Design",                 ects: 5, type: "C", grade: "" },
          { id: uid(), code: "SE308",   name: "Distributed Systems",             ects: 5, type: "C", grade: "" },
          { id: uid(), code: "ELEC302", name: "Computer Vision",                 ects: 4, type: "E", grade: "" },
          { id: uid(), code: "ELEC304", name: "Blockchain Fundamentals",         ects: 4, type: "E", grade: "" },
        ],
      },
    ],
  },
